...
+ Во первых вам нужно [скачать apk файл](https://github.com/bumsun/masks_sdv_hack/blob/main/app/release/app-release.apk), чтобы посмотреть на возможности и качество масок.
...
+ Так же есть [такое](https://app.vectary.com/) более функциональное, но более сложное для освоения онлайн решение.
