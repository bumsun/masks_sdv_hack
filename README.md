...
Данная библиотека восполнит этот пробел и поможет быстро найтроить любую маску по ваши нужды.
...
1. Для описание бесконечного количества масов используется тройна вложенности.
```
List<String[][]> maskConfig = new ArrayList<>();
```
