...
public class AugmentedFacesActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
  ...
  private final AugmentedFaceRenderer augmentedFaceRenderer2 = new AugmentedFaceRenderer();
  ...
  private final ObjectRenderer deerHornsObject = new ObjectRenderer();
  ...
  private final float[] tempSquareMatrix = new float[16];


  private final float[] leftEarMatrix = new float[16];
  private static final float[] DEFAULT_COLOR = new float[] {0f, 0f, 0f, 0f};
  private int textureType = 0;
  private MasksHelper masksHelper = new MasksHelper();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ImageView leftIV = (ImageView) findViewById(R.id.leftIV);
    ImageView rightIV = (ImageView)findViewById(R.id.rightIV);
    leftIV.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        if(textureType > 0) {
          ...
          textureType = masksHelper.getMaskCount()-1;
        }
      }
    });
    ...
    rightIV.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        if(textureType < masksHelper.getMaskCount()-1) {
          textureType++;
        }else{
          textureType = 0;
        }
...
//      augmentedFaceRenderer2.createOnGlThread(this, "models/simple_mask.png");
...
//
//      deerHornsObject.createOnGlThread(this, "models/flat_square.obj", "models/3_deer_horns.png");
//      deerHornsObject.setMaterialProperties(0.0f, 1.0f, 0.1f, 6.0f);
//      deerHornsObject.setBlendMode(ObjectRenderer.BlendMode.AlphaBlending);
//
...
//      leftEarObject.setBlendMode(ObjectRenderer.BlendMode.AlphaBlending);
      ...
      for (String[][] mask : MaskConfig.getInstance().getMaskConfig()){
        masksHelper.addMaskObjects(getApplicationContext(),mask);
      }
...
//        Log.d("myLogs","face.getCenterPose():"+face.getCenterPose());
        ...
        masksHelper.renderMask(face,viewMatrix, projectionMatrix, colorCorrectionRgba,modelMatrix, textureType);

//        if(textureType == 0) {
//          masksHelper.renderMask(face,viewMatrix, projectionMatrix, colorCorrectionRgba,modelMatrix, 0);
//        }else if(textureType == 1) {
//          masksHelper.renderMask(face,viewMatrix, projectionMatrix, colorCorrectionRgba,modelMatrix, 1);
//        }else if(textureType == 2) {
//          masksHelper.renderMask(face,viewMatrix, projectionMatrix, colorCorrectionRgba,modelMatrix, 2);
//        }else{
...
//
////          face.getCenterPose().makeTranslation(0, 0, 0).toMatrix(rightEarMatrix, 0);
//
//          float[] rightEar = face.getRegionPose(RegionType.FOREHEAD_RIGHT).getTranslation();
//          Log.d("myLogs","rightEar = " + Arrays.toString(rightEar));
//          Log.d("myLogs","my right Ear= " + Arrays.toString(face.getCenterPose().compose(face.getCenterPose().makeTranslation(-0.03f, 0.04f, -0.02f)).getTranslation()));
//
////          face.getCenterPose().compose(face.getCenterPose().makeTranslation(-0.03f, 0.06f, 0.05f)).toMatrix(rightEarMatrix, 0);
//
//
//
//
